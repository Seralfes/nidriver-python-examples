"""Example taken from a public, unsupported GitHub repository for a SysCfg Python API: https://github.com/tkrebes/nisyscfg-python/blob/main/examples/print_temperatures.py"""
...
def print_resource_temperature(resource, indent):
    for name, reading in itertools.zip_longest(
        ...
        print(indent + "{}: {}".format(name or "Temperature", reading) + "°C")
