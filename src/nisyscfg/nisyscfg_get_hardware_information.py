"""NI System Configuration - Get Hardware Information.

This example demonstrates how to get the name, model, S/N and firmware revision (if any) of all the NI devices present in a system.
"""
import nisyscfg
...
with nisyscfg.Session() as session:
    ...
    for resource in session.find_hardware(filter):
        print(line_format.format(resource.expert_user_alias[0],
                                 ...
                                 resource.firmware_revision if resource.supports_firmware_update else "N/A"))
